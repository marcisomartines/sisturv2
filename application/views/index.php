    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo"> 
          ...
          <span class="logo-lg"><b>SISTUR</b> System</span>
        </a> 
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    ...
                    <!-- INICIO NOTIFICAÇÕES -->
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-aqua"></i> 5 membros novos foram cadastrados
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-warning text-yellow"></i> descrições muito grande podem causar problema de design
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-red"></i> 5 membros novos foram cadastrados
                        </a>
                      </li>
                      <li>
                        <a href="#">
