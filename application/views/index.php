          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3><?=$this->passagem->reservaFeita()?></h3>
                  <p>Reservas no mês</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  <h3><?=$this->passagem->reservaConfirmada()?> <sup style="font-size: 15px">passagem(s)</sup></h3>
                  <p>Confirmadas</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <h3><?=$this->passagem->reservaAusente()?> <sup style="font-size: 15px">passagem(s)</sup></h3>
                  <p>Ausentes</p>
                </div>
                <div class="icon">
